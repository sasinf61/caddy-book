      ...
      <div className="w-full max-w-md"> {/* Container for both form and social login */}
        ...
        <form onSubmit={handleSubmit} className="form-card w-full p-8 space-y-6 bg-white/10 backdrop-blur-md rounded-lg shadow-2xl">
          ...
          <div className="relative">
            <input type="text" value={username} onChange={(e) => setUsername(e.target.value)} required className="input-field w-full px-4 py-3 text-white bg-black/30 border border-white/20 rounded-lg focus:outline-none focus:ring-2 focus:ring-green-500" placeholder="Username" />
          </div>
